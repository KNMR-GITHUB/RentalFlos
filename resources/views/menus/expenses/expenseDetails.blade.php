        ...
        <div class="flex flex-col justify-evenly bg-white rounded-sm border mt-8 border-gray-300 p-4">
            ...
            <div class="flex gap-6 border-b border-gray-300">
                <div id="detailsTitle" class="py-3 text-blue-600 border-b-2 border-blue-600">
                    <h3 onclick="display('details', 'detailsTitle')" class=" hover:text-blue-500 h-full"><i class="fa-regular fa-user"></i> Expenses</h3>
                </div>
            ...
            <!-- details container -->
            <div id="details" class="grid mt-6 border border-gray-300 md:grid-cols-[1fr,1fr] lg:grid-cols-[1fr,3fr] grid-cols-2">
                    ...
                    <div class="flex gap-4">
                        @for ($i = 0; $i < count($list); $i++)
                            ...
                            @if ($extension == 'xlsx')
                                ...
                                <div class="block">
                                    <a href="{{route('downloadPropertiesFile',['propId' => $expense->id, 'fileName' => $hello])}}"><img src="/images/xlsx_icon.png"  class= "h-[150px] w-[150px]" alt=""></a>
                                    <p>{{$fileName[1]}}</p>
                                </div>
                            @elseif ($extension == 'pdf')
                                <div class="block">
                                    <a href="{{route('downloadPropertiesFile',['propId' => $expense->id, 'fileName' => $hello])}}"><img src="/images/pdf-file-format.png"  class= "h-[150px] w-[150px]" alt=""></a>
                                    <p>{{$fileName[1]}}</p>
                                </div>
                            @elseif ($extension == 'csv')
                                <div class="block">
                                    <a href="{{route('downloadPropertiesFile',['propId' => $expense->id, 'fileName' => $hello])}}"><img src="/images/csv-file.png"  class= "h-[150px] w-[150px]" alt=""></a>
                                    <p>{{$fileName[1]}}</p>
                                </div>
                            @elseif ($extension == 'doc' || $extension == 'docx')
                                <div class="block">
                                    <a href="{{route('downloadPropertiesFile',['propId' => $expense->id, 'fileName' => $hello])}}"><img src="/images/word.png"  class= "h-[150px] w-[150px] px-4" alt=""></a>
                                    <p>{{$fileName[1]}}</p>
                                </div>
                            @else
